...
@media (max-width:520px){.community-topbar{grid-template-columns:42px minmax(0,1fr) auto;gap:8px;padding:10px 10px}.community-topbar h2{font-size:17px}.community-topbar small{font-size:9px}.community-user{max-width:112px}.community-user strong{font-size:11px}.community-user small{font-size:8px}}
`;
