...
async function googleLogin() {
  ...
  // Do not link the anonymous visitor account. Direct Google sign-in is more
  // reliable on mobile and avoids auth/credential-already-in-use dead ends.
  // Try popup first because it gives immediate feedback; fall back to redirect
  // when the browser/PWA blocks popup authentication.
  try {
    ...
    <div class="community-shell">
      ...
      <div class="community-scroll">
        <div class="community-composer">
          <div class="community-composer-title"><span>Chia sẻ cùng anh em</span><button class="community-login-btn" type="button">Đăng nhập Google</button></div>
